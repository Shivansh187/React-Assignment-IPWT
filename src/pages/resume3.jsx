    ...
    const { open } = this.state;  
        if (open) {  
          return (
            <>
            <div className="my-5">
              <h1 className="text-center"><u>React JS: Resume using Events</u> <br/><br/> Click the Button to Hide Resume</h1>
            </div><center><button onClick={this.toggle} class="btn btn-primary">Click Here</button></center>
          ...
          return (
            <>
            <div className="my-5">
              <h1 className="text-center"><u>React JS: Resume using Events</u> <br/><br/> Click the Button to Display Resume</h1>
            </div>
            <div className="container-fluid nav_bg" >
                  <div className="row">
                    <div className="col-10 mx-auto">
                      <center><button onClick={this.toggle} class="btn btn-primary">Click Here</button></center>
                    </div>
                </div>
              </div>
              </>
